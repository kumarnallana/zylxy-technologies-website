export const heroStyles = {
  section:
    "relative min-h-[100svh] lg:min-h-screen bg-[#050E21] flex flex-col justify-center pt-28 lg:pt-32 pb-24 lg:pb-32 px-6 lg:px-8 overflow-hidden",
  atmosphereGlow:
  ...
  leftColumn: "lg:col-span-7 flex flex-col items-start text-left mt-8 lg:mt-0",

  rightColumn:
    "hidden lg:flex lg:col-span-5 relative justify-center items-center h-[500px] w-full pointer-events-none",

  badgeContainer:
    "inline-flex items-center gap-2 bg-[#2563EB]/15 border border-[#2563EB]/30 rounded-full px-4 py-1.5 mb-6 lg:mb-8",
  ...
  heading:
    "font-syne font-extrabold text-[38px] sm:text-5xl md:text-6xl text-white tracking-tighter leading-[1.05] mb-6 max-w-2xl",
  headingGradient:
    "bg-gradient-to-r from-[#60A5FA] to-[#06B6D4] bg-clip-text text-transparent inline-block",

  descPrimary:
    "text-[16px] lg:text-[17px] text-white/60 font-inter leading-relaxed max-w-lg mb-3.5",
  descSecondary:
    "text-[13px] text-white/30 font-inter tracking-wide mb-8 lg:mb-11",

  btnGroup:
    "flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto mb-10 lg:mb-16",
  primaryBtn:
  ...
  statsCard:
    "bg-white/[0.04] p-5 lg:p-5.5 text-center flex flex-col justify-center",
  statsValue:
    "font-syne font-extrabold text-[28px] sm:text-3xl lg:text-4xl text-white tracking-tighter leading-none mb-1.5",
  statsLabel:
    "text-[11px] lg:text-[12px] font-medium font-inter text-white/50 mb-1",
  statsNote:
    "text-[9px] lg:text-[10px] font-semibold font-inter text-[#06B6D4] tracking-wider",
